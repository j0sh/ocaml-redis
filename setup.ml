...
(* OASIS_START *)
(* DO NOT EDIT (digest: ecb1796c479f009421252ee5de8cd290) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("lwt",
                               Some (OASISVersion.VGreaterEqual "2.4.4"));
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\001\001A6r\174O(\254\139\020\022!\233\182v";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
